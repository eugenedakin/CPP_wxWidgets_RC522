...
Ensure the SPI communication protocol is enabled on the Raspberry Pi. The below video shows: 1) running, and 2) waving an RFID tag over a sensor to show the ID number.
